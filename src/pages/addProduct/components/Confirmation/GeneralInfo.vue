<template>
    <div class="confirmation-base">
        <div class="confirmation-base__item" v-if="props.data.propertyType">
            <Paragraphe class="confirmation-base__title">Type de Bien</Paragraphe>
            <Paragraphe>{{ getPropertyType(props.data.propertyType, propertyType)}}</Paragraphe>
        </div>
        <!-- <hr class="confirmation-base__divider"> -->
        <div class="confirmation-base__item" v-if="props.data.title">
            <Paragraphe class="confirmation-base__title">Titre de l'anonce</Paragraphe>
            <Paragraphe>{{props.data.title}}</Paragraphe>
        </div>
        <!-- <hr class="confirmation-base__divider"> -->

        <div class="confirmation-base__item" v-if="props.data.transactionType">
            <Paragraphe class="confirmation-base__title">Type de transaction</Paragraphe>
            <Paragraphe>{{props.data.transactionType}}</Paragraphe>
        </div>
        <!-- <hr class="confirmation-base__divider"> -->

        <div class="confirmation-base__item" v-if="props.data.disponibility">
            <Paragraphe class="confirmation-base__title">Disponibilité</Paragraphe>
            <Paragraphe>{{ props.data.disponibility === 'A partir de' ? formatDateFr(props.data.disponibilityTime) : props.data.disponibility}}</Paragraphe>
        </div>
        <!-- <hr class="confirmation-base__divider"> -->

        <div class="confirmation-base__item-file" v-if="props.data.leaseCopy">
            <Paragraphe>Fichier de bail</Paragraphe>
            <a :href="createUrlFile(props.data.leaseCopy)" target="_blank" rel="noopener noreferrer" class="confirmation-base__file">
...
const propertyType = computed(() => store.getters['AddProductModule/getPropertyType']);
