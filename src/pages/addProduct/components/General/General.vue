<script lang="ts" setup>
    ...
    // import {FontAwesomePromise} from "@/composables/useFontAwesome";z
    ...
    function checkItem(item: any, allItem: any) {
        ...
        if (!content) {
            ...
            checked.value = checked.value.filter((i: any) => i.optionId !== +item);
        }
...
<template>
    <div class="general__container">
        <div class="general__master-container">
                    ...
                    <div class="general__features-content">
                        <div class="general__features-container">
                            <div
                                ...
                                v-for="(item, index) in levelItem.item"
                                :key="index"
                                @click="
                                    getDropedList({
                                        id: item.id,
                                        ...
                                        <div class="inside__room-description">
                                            ...
                                            >
                                                <Input
                                                    ...
                                                    :min="0"
                                                    placeholder='0'
                                                    :unity="roomItem.name == 'surface' ? 'm²' : ''"
                                                    :default-value="
                                                        propertyDatas[roomItem.name]
                                                    "
                                                />
                                                <div
                                                    v-else-if="
                                                        roomItem.type === 'select'
                                                    "
            ...
            <Paragraphe class="general__add-container" @click="incrementLevel">
                ...
                <template #content>
                    ...
                    >
                        <Input
                            ...
                            :label="item.label"
                            :input-type="item.type"
                            @input="handleChangeModalValue($event, +indexItem)"
                        />
                    </div>
            ...
            >
                <template #content>
                    ...
                    <div class="general__modal-footer">
                        <Button @click="handleAddOptions"> Valider </Button>
                    </div>
                </template>
            </Modal>
            ...
            <template #content>
                <div class="general__container">
                    <Input
                        ...
                        label="Nouveau nom"
                        @input="handleChangeLevelName($event, levelToChange)"
                    />
                    <Button type-button="secondary" @click="handleSaveNameLevel"
                        >Valider</Button
                    >
                </div>
            </template>
