            ...
            <div class="search-simple-property__choice__list">
                ...
                >
                    ...
                    <transition appear name="fadeHeight" mode="in-out">
                        <div v-if="isActiveZoning" class="w-full">
                            <span class="info mb-[14px]">
    ...
    watch(
        ...
        (ac: any) => {
            if (ac) {
                ...
                console.log('maps params >>>', searchParam.value);
    ...
    async function handleSearch() {
        try {
            ...
            if (code === 200) {
                ...
                console.log("result search >>>", mapCoordinates.value);
...
<style lang="scss" scoped>
    ...
    .search-simple-property {
        ...
        &__choice {
            @apply transition-all overflow-hidden p-[10px] w-full flex flex-col justify-center items-center border border-primary text-primary rounded-[8px] hover:cursor-pointer gap-[14px] bg-white;
            @screen md {
                @apply p-[20px];
            }
            & > span {
                @apply uppercase font-[600];
            }
            &:deep() {
            ...
            &__list {
                ...
                // @screen md {
                //     @apply  absolute top-[10px] right-0 w-[calc(100%-55px)] z-[1000];
                // }
            }
        }
    }
