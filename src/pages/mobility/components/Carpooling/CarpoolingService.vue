<template>
    <div class="carpooling__container">
        ...
        <Result
            v-if="showResult"
            title="Tous les covoiturages disponibles"
        ...
        >
            <div class="carpooling-card__container">
                <div class="carpooling-card__items--container">
                    <Paragraphe class="text-primary font-[600]">
                        Je suis disposé à proposer mes services de covoitureurs
                        dans un périmètre
                    </Paragraphe>
                    ...
                    <div class="carpooling-card__items carpooling-card__card">
                        <!-- <div class="carpooling-card__input-date">
                            <div class="carpooling-card__input-date-container">
                                <InputDate
                        ...
                        <AddIncremented label="Jours suivant" increment-type="inputDate" name="nextDay" />
                    </div>
                    <div class="carpooling-card__items">
                        <TimePicker
                    ...
                    <div class="carpooling-card__items--container">
                        <Paragraphe class="text-primary font-[600]">
                            Je suis disposé à proposer mes services de
                            covoitureurs dans un périmètre
                        </Paragraphe>
...
<script lang="ts" setup>
    ...
    async function handleSubmit() {
        console.log('params\n', params.value);
        loading.value = true;
        await store.dispatch('MobilityModule/propositionService', params.value);
        handleShowResult();
        loading.value = false;
    }
