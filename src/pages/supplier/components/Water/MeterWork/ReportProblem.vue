        ...
        >
            <div class="supplier-work__container">
                <Title
                    type="h2"
                    weight="600"
                    label="Signalez un problème quant à la couleur, l’odeur ou le goût de votre eau potable ou quant à un problème d’approvisionnement"
    ...
    function extractValue() {
        moveBranchementData.value = props.relativeWorkConnection
            .filter(
                (item) =>
                    item.key ===
                    'Signalez un problème quant à la couleur, l’odeur ou le goût de votre eau potable ou quant à un problème d’approvisionnement'
            )
            .at(-1);
    }
</script>
