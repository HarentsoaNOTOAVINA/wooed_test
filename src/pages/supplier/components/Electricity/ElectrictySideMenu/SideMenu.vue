    ...
    <div class="sideMenu__section">
        ...
        <transition mode="out-in" name="fadeHeight">
            ...
            >
                ...
                >
                    <template v-for="item in actvieDataSideMenu">
                        <a-menu-item
                            v-if="!item.subMenu"
                        ...
                        >
                            ...
                            <template v-if="item.subMenu">
                                <a-menu-item
                                    ...
                                    :disabled="
                                        supplier.toLowerCase() !== 'sibelga' &&
                                        subItem.name === 'greenCard'
                                    "
                                    :title="subItem.label"
...
<script setup lang="ts">
    ...
    const supplier = computed(
        () => store.getters['SupplierModule/getSupplierName']
    );
    ...
    const selectedKeys = ref<Array<string>>(['myConnection']);
    const openKeys = ref<Array<string>>(['connectionGas']);
    const toggleShow = ref<boolean>(false);

    const actvieDataSideMenu = shallowRef<any>(dataSideMenu);
    function handleClick(item: any, key: string) {
        ...
        // openKeys.value = [key];
        if (key === 'injectionMeter') {
            store.dispatch('SupplierModule/updateEnergyType', 'solar');
        } else {
            store.dispatch('SupplierModule/updateEnergyType', 'electricity');
        }
    }
