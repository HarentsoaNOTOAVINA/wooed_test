        ...
        >
            <div class="supplier-work__container">
                ...
                <div class="supplier-work__items">
                    ...
                    <!-- TABLEAU -->
                    <WorkTabs
                        :relativeWork="counterData"
                        type="simple"
                        :supplier="supplier"
                        work-type="Travaux relatifs au compteur"
                    />
                </div>
            </div>
        </MainCard>
...
<script lang="ts" setup>
    ...
    function extractValue() {
        counterData.value = props.relativeWorkCounter.filter(
            (item) => item.key === '(R)ouvrir une installation au gaz naturel/un compteur scellé(e)'
        ).at(-1);
    }
</script>
