      ...
      <template #modalContent>
        <div>
          ...
          <div class="modal-form">
            ...
            <Button type-button="primary" :disabled="currentSession === undefined" class="btn" @click="setSession"> Créer </Button>
          </div>
        </div>
      </template>
    </MainCard>
...
onMounted(async () => {
  store.commit("SyndicModule/SET_CURRENT_SESSION", { type: 'currentExpenses' });
