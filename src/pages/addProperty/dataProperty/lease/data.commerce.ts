...
export const leaseCommerceDataClassic : IAddProperty[] = [
    {
...
export const leaseCommerceDataTouristic : IAddProperty[] = []
export const leaseCommerceDataMinutes : IAddProperty[] = []
export const leaseCommerceDataColocation : IAddProperty[] = []