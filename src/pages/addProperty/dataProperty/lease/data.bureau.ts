...
export const leaseOfficeDataClassic : IAddProperty[] = [
    {
...
export const leaseOfficeDataTouristic : IAddProperty[] = []
export const leaseOfficeDataMinutes : IAddProperty[] = []