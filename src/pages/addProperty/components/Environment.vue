                            ...
                            >
                                ...
                                <div class="doc-control spaceV">
                                    ...
                                    <UploadImage
                                        ...
                                        "
                                        :max-count="1"
                                        :default-file-list="defaultFile['document']"
                                    />
                    ...
                    <div class="envi__items">
                        <div class="doc-control spaceV">
                            ...
                            <UploadImage
                                ...
                                "
                                :max-count="1"
                                :default-file-list="documentLists('Permis d\'environnement')"
                            />
                        ...
                        <div class="envi__parcel-sis" v-if="isFrance">
                            <div class="envi__parcel-sis-ok" v-if="hasSis">
                                <Paragraphe
                                    ...
                                    d’Information sur les Sols (SIS), c-à-d
                                    qu’il est affecté totalement ou
                                    partiellement par une pollution connue par
                            ...
                            <div class="envi__parcel-sis-not" v-else>
                                <Paragraphe
                                    >Votre terrain n’est pas répertorié en
                                    Secteur d’Information sur les Sols (SIS),
                                    c-à-d qu’il n’est pas affecté totalement ou
                                    partiellement par une pollution connue par
                                    les services de l’État. <br />
                                    Aucun diagnostic de pollution des sols ne
                                    doit être établi dans le cadre de la vente
                                    de votre parcelle.
                                </Paragraphe>
                            </div>
                        </div>
                        ...
                        <div class="envi__items">
                            ...
                            <div class="envi__parcel-content">
                                <div class="envi__parcel-infoReqAtt">
                                    <div class="envi__parcel-info-info">
                                        ...
                                        >
                                            <Paragraphe
                                                >ATTESTATION DU SOL (B) /
                                                INFORMATIONS CASIPO
                                                (Lux)/INFORMATION SUR LES SIS
                                                (France). <br />
                                                <span class="italic">
                                                    (Belgique) Selon la loi,
                                                    l'offrant doit disposer de
                            ...
                            >
                                ...
                                <UploadImage
                                    ...
                                    "
                                    :max-count="1"
                                    :default-file-list="defaultFile['attestationFile']"
                                />
                            ...
                            >
                                <div class="envi__parcel-notaire">
                                    <Paragraphe class="title-upload"
                                        >Charger un notaire de procéder à la
                                        demande
                                    </Paragraphe>
                                ...
                                <div class="envi__parcel-reqAtt spaceV">
                                    <Button
                                        ...
                                        >Demander l'attestation du sol à
                ...
                <Modal
                    ...
                    ><template #content>
                        <div class="envi__in-region" v-if="inRegion">
                            ...
                            <div class="envi__radio-contact">
                                ...
                                <UploadImage
                                    ...
                                    "
                                    :max-count="1"
                                    :default-file-list="defaultFile['docFile']"
                                />
                            </div>
                        ...
                        <div class="env__country">
                            ...
                            >
                                <Paragraphe
                                    >Envoyer la demande à CASIPO</Paragraphe
                                >
...
<script lang="ts" setup>
    ...
    const defaultFile = propertyDatas.value; // Obtenez la valeur du getter
    ...
    function handleUploadPermis(docsUpload: any, label?: string, name?: string) {
        paramsDoc.value = formatDocument(docsUpload, label, name);
