                ...
                <div class="general__features">
                    ...
                    >
                        ...
                        <div class="general__features-content">
                            <!-- Selection des equipement de la vie quotidienne -->
                            ...
                            <div class="inside__details-container">
                                <!-- v-if="showRoom[idLevelItem].showLevel" -->
                                <div
                                    class=""
                            ...
                            <!-- Contenu cuisine -->
                            <!-- <div
                                class="inside__details-container"
                                v-if="showKitchen[idLevelItem].showLevel"
                            >
                                <Select
                                    label="Les éléments de la cuisine"
                                    name="kitchen"
                                    placeholder="Selectionnez les éléments de votre cuisine"
                                    :disabled="!allKitchenElt.length"
                                    :loading="!allKitchenElt.length"
                                    :options="allKitchenElt"
                                    @change-select="handleSelectKitchenElt"
                                    mode="multiple"
                                />
                            </div> -->
                        </div>
