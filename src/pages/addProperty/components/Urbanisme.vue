            ...
            <div class="urba__class spaceV">
                ...
                <div class="urba__items">
                    <label class="para-bold"
                        >Le bien est classé &nbsp;<span class="no-class"
                            >Non</span
                        >
            ...
            <div class="urba__pemit spaceV">
                ...
                <div class="urba__items">
                    <span class="para-bold"
                        >Insérer ici les permis d'urbanisme délivrés pour le
                        bien
                    </span>
                    <UploadImage
                        ...
                        @uploadUpdate="
                            handleUploadPermit(
                                $event,
                                'Permis d\'urbanisme',
                                'documentUrbanismeFile'
                            )
                        "
                        :max-count="1"
                        :default-file-list="documentLists('Permis d\'urbanisme')"
                    />
                ...
                <div class="urba__items">
                    <div class="urba__info-container">
                        ...
                        <div class="urba__info-content" v-if="showInfo">
                            (Belgique) Selon la loi, l'offrant doit disposer de
                            ces renseignements avant de conclure une convention
                    ...
                    <div class="urba__info-reqDem">
                        ...
                        <Button
                            ...
                            >Demander les renseignements urbanistiques à
                            ...
                            <div class="env__request-notary">
                                ...
                                <div class="urba__info-upload spaceV">
                                    ...
                                    <UploadImage
                                        ...
                                        "
                                        :max-count="1"
                                        :default-file-list="defaultFile['rensgnementsUrbainfile']"
                                    />
...
<script lang="ts" setup>
    ...
    import { formatDocument, documentLists, valueParams } from '../utils/default-value';
    ...
    function handleUploadPermit(value: any, label?: string, name?: string) {
        paramsDoc.value = formatDocument(value, label, name);
    ...
    function setDataToStore(value: any) {
        ...
        console.log(valueData, 'Value urba');
    }
    ...
    function next() {
        ...
        //     documents: [...params.value.documents, ...paramsDoc.value],
        // };
        // console.log("URBANISME", newParams);
