        ...
        <div class="address__container">
            ...
            >
                <Input
                    ...
                    @input="inputHandler"
                    :default-value="locationParams.address"
                />
                <!-- :has-error="{
...
<script setup lang="ts">
    ...
    onMounted(() => {
        getUserAdress();
        // locationParams.value = valueParams(data.value);
    });
    ...
    watch(
        () => defaultLatLng.value,
        (v) => {
            // defaultLatLng.value = v;
            console.log(v, "default lat lngs");
    ...
    function handleClickMap(e: LatLng) {
        ...
        console.log(e, 'ity ny nouvelle adresse refa miclick map');
    }
    function locationHandler(params: Array<gm_ILocationResult>) {
        ...
        // defaultLatLng.value = {
        //     lat: formattedParams.latitude,
        //     lng: formattedParams.longitude
        // }
    }
    ...
    function inputHandler(obj: { address: string } | object) {
        console.log(obj, "ity ny adress ao amin'ny input");
