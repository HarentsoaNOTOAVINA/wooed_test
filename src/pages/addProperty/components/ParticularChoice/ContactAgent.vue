            ...
            <div class="add__content">
                ...
                <div class="text-left w-full">
                    <Title type="h3" weight="600">
                        Liste des agents immobiliers dans un rayon de 3 kms du
                        bien
                    </Title>
                </div>
                <ListeAgent :data="agentListOptions" @change="handleChoiceAgents" />
...
<script lang="ts" setup>
    ...
    import ListeAgent from './ListeAgent.vue';
    ...
    async function getPropertyType() {
        const data = await store.dispatch('AddProductModule/getProperyType');
        options.value = data;
    }
    ...
    function handleSelect(value: any) {
        for (let i in value) {
            if (i === 'product') {
                ...
                parameters.value.thePropertyType = product.value;
            } else if (i === 'agents') {
    ...
    function handleChoiceAgents(value: any) {
        
        parameters.value.agencyIds = value
        console.log("value agent >>>>", parameters.value.agencyIds);
