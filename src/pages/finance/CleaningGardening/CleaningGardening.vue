<template>
    <FinanceCard
        label-title="Nettoyage et Jardinage"
            ...
            <table class="coproperty__table--item table-auto">
                <tbody class="coproperty__table--body">
                    ...
                    <tr class="coproperty__table--row">
                        <td>Sur 1 mois</td>
                        <td>
                            {{ extraordinaryFilteredAmount.toLocaleString() }} €
                        </td>
                    </tr>
                    <tr class="coproperty__table--row">
                        <td>Total des dépenses depuis le 1er janvier 2021</td>
                        <td>
                            {{ extraordinaryFilteredAmount.toLocaleString() }} €
                        </td>
                    </tr>
...
<script setup lang="ts">
    ...
    import CleaningGardeningForm from './CleaningGardeningForm/CleaningGardeningForm.vue';
    ...
    const extraordinaryFilteredAmount = computed(() => {
        if (!filterRes.value.length) {
            ...
            return filterRes.value
                .filter((item) => item.type === 'gardening')
                .reduce((cum, curr) => cum + curr.amount, 0);
        }
    });
