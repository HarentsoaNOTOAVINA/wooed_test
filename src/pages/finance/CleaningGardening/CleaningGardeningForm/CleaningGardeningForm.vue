<template>
    <div>
        <Title
            ...
            :label="`${typeRender}`"
            :weight="400"
            class="cleaning-gardening__items--title"
        />
        <hr class="__hr" />
        <div
            v-for="item in factureList"
            :key="item.id"
            class="cleaning-gardening__items"
        >
            <div class="cleaning-gardening__form-item-wrap">
                <div class="upload__container">
                    <label>
                        <span> Coût/facture {{ item.id + 1 }} </span>
                        <button
                ...
                <div class="cleaning-gardening__field-wrap">
                    <div class="cleaning-gardening__form-item-wrap">
                        <label>
                        ...
                        <InputDate
                            ...
                            "
                            name="Expiration1"
                            class="cleaning-gardening__form-item"
                        />
                    </div>
                    <div class="cleaning-gardening__form-item-wrap">
                        <label>
        ...
        <div class="cleaning-gardening__add-facture-btn flex justify-center">
            <Button @click="onAddFatcture">
                <AddIcon /> Facture {{ typeRender }}</Button
            >
        </div>
        <div class="cleaning-gardening__items cleaning-gardening__amount">
            <Paragraphe class="cleaning-gardening__amount-content">
                Montant annuel est :
            </Paragraphe>
            <span class="cleaning-gardening__amount-value">
