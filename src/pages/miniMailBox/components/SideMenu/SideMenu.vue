    ...
    <div class="sideMenu__section">
        ...
        <transition mode="out-in" name="fadeHeight">
            <div
                ...
                v-show="toggleShow"
            >
                <Title type="h2" label="Boite mail " class="sideMenu__title" />
                <a-menu
...
<script setup lang="ts">
    ...
    const selectedKeys = ref<Array<string>>(['receptionBox']);
    const openKeys = ref<Array<string>>(['receptionBox']);
...
<style lang="scss" scoped>
    ...
    .sideMenu {
        ...
        &__title {
            @apply font-[600] text-[16px] pl-[12px];
        }
    }
