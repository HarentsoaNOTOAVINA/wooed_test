...
<script setup lang="ts">
    ...
    import { dataSideMenu } from '@/pages/transport/components/TransportSideMenu/DataSideMenu';
    ...
    const emit = defineEmits<{
        (k: 'set-active-component', v: any): void;
    ...
    function setActiveComponent(component: any) {
        store.dispatch("TransportModule/setActiveComponent", component);
    }
</script>
