      ...
      <div class="currentContent__container-container">
        <CardWrapper class="currentContent__container-wrap">
          ...
          <div class="proposition__container">
            <div v-if="votes.length > 0">
              <div v-for="(vote, index) in votes" :key="index" class="proposition__items">
                ...
                <div class="w-1/3 flex justify-end">
                  <div
                    v-if="vote.requestPrecision"
                    class="proposition__precision-request"
                  >
            ...
            <CardWrapper v-else>
              <Empty description="Aucune vote n'a été fait sur cette proposition pour le moment" />
            </CardWrapper>
          </div>
        </CardWrapper>
      </div>
...
.proposition {
  ...
  &__items {
    ...
    font-size: 14px;
    line-height: 17px;
    @apply bg-white text-grayIcon flex flex-row items-center justify-between p-[16px] border-2 border-gray rounded-[4px] mb-2;
  }
