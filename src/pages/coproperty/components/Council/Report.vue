...
const ReportForm = defineAsyncComponent(() => import("@/pages/syndic/components/Council/ReportForm.vue"));
const ReportList = defineAsyncComponent(() => import("@/pages/syndic/components/Council/ReportList.vue"));
