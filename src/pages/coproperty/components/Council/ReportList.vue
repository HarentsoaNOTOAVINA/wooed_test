...
watch(() => activeDisplayTitle.value,
  (value) => {
...
onMounted(async () => reportList.value = await store.dispatch("SyndicModule/fetchCouncilReports"));
...
function backToInvoiceList() {
  ...
  breadcrumbData.value[2].label = "Liste de factures";
}
