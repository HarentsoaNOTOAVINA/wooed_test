<template>
    <div class="tankCost__container">
        <div class="tankCost__header">
            <div class="tankCost__back" @click="prev">
                <BackButtonVue />
            </div>
            <Paragraphe class="tankCost__title">Calculer le coût</Paragraphe>
        </div>
        <hr class="separator" />
        <div class="tankCost__result">
            <!--<a-alert
                v-if="dataRegister.idExpert == null && !loading"
                class="mb-2"
                message="Veuillez contacter une entreprise d'entretien de Citerne certifiée afin de valider votre entretien!"
                banner
            />-->
            <Paragraphe class="para" v-if="!loading"
                >Le coût de l'entretien de votre Citerne est de :
            </Paragraphe>
            <div class="tankCost__cost" v-if="!loading">
